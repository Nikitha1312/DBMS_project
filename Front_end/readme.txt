 ...
 to choose from the following:  
    ...
    All the images that are supposed to be displayed on the menu page should be placed in the FoodList folder with image name as the corresponding FoodID.    
    Background images should be placed in Pictures folder. 
